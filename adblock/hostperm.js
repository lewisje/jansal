...
f.Write(http.responseText.replace(/\timage\t/g,"\tobjectsubrequest\t"));
...
f.Write(http.responseText.replace(/\timage\t/g,"\txmlhttprequest\t"));
...
f.Write(http.responseText.replace(/\/\/.*[\r\n]/g,"").replace(/PRIMARY /g,"host\tobjectsubrequest\t2\t").replace(/ blockeddomain\.hosts/g,""));
...
f.Write(http.responseText.replace(/\/\/.*[\r\n]/g,"").replace(/PRIMARY /g,"host\txmlhttprequest\t2\t").replace(/ blockeddomain\.hosts/g,""));
...
f.Write(list.replace(/127\.0\.0\.1[ \t]+/g,"host\tobjectsubrequest\t2\t"));
...
f.Write(list.replace(/127\.0\.0\.1[ \t]+/g,"host\txmlhttprequest\t2\t"));
http.open("GET",website="https://spyeyetracker.abuse.ch/blocklist.php?download=hostfile",false);
http.setRequestHeader("Accept","text/html");
http.send();
...
f.Write(http.responseText.replace(/#.*[\r\n]/g,"").replace(/127\.0\.0\.1[ \t]+/g,"host\tobjectsubrequest\t2\t"));
...
f.Write(http.responseText.replace(/#.*[\r\n]/g,"").replace(/127\.0\.0\.1[ \t]+/g,"host\txmlhttprequest\t2\t"));
...
f.Write(http.responseText.replace(/[\r\n]#.*/g,"").replace(/[\r\n]/g,"\nhost\tobjectsubrequest\t2\t").replace(/.*$/,"").replace(/^#.*[\r\n]/g,"").replace(/[ \t]#.*[\r\n]/g,"\n"));
...
f.Write(http.responseText.replace(/[\r\n]#.*/g,"").replace(/[\r\n]/g,"\nhost\txmlhttprequest\t2\t").replace(/.*$/,"").replace(/^#.*[\r\n]/g,"").replace(/[ \t]#.*[\r\n]/g,"\n"));
http.open("GET","http://dshield.org/feeds/suspiciousdomains_High.txt",false);
http.setRequestHeader("Accept","text/html");
http.send();
f.Write(http.responseText.replace(/[\r\n]Site[\r\n]/g,"\n").replace(/[\r\n]#.*/g,"").replace(/\t?[\r\n]/g,"\nhost\tcookie\t2\t").replace(/^#.*[\r\n]/g,"").replace(/ #.*[\r\n]/g,"\n").replace(/host.*\t$/g,""));
f.Write(http.responseText.replace(/[\r\n]Site[\r\n]/g,"\n").replace(/[\r\n]#.*/g,"").replace(/\t?[\r\n]/g,"\nhost\tdocument\t2\t").replace(/^#.*[\r\n]/g,"").replace(/ #.*[\r\n]/g,"\n").replace(/host.*\t$/g,""));
f.Write(http.responseText.replace(/[\r\n]Site[\r\n]/g,"\n").replace(/[\r\n]#.*/g,"").replace(/\t?[\r\n]/g,"\nhost\tdtd\t2\t").replace(/^#.*[\r\n]/g,"").replace(/ #.*[\r\n]/g,"\n").replace(/host.*\t$/g,""));
f.Write(http.responseText.replace(/[\r\n]Site[\r\n]/g,"\n").replace(/[\r\n]#.*/g,"").replace(/\t?[\r\n]/g,"\nhost\tfont\t2\t").replace(/^#.*[\r\n]/g,"").replace(/ #.*[\r\n]/g,"\n").replace(/host.*\t$/g,""));
f.Write(http.responseText.replace(/[\r\n]Site[\r\n]/g,"\n").replace(/[\r\n]#.*/g,"").replace(/\t?[\r\n]/g,"\nhost\tgeo\t2\t").replace(/^#.*[\r\n]/g,"").replace(/ #.*[\r\n]/g,"\n").replace(/host.*\t$/g,""));
f.Write(http.responseText.replace(/[\r\n]Site[\r\n]/g,"\n").replace(/[\r\n]#.*/g,"").replace(/\t?[\r\n]/g,"\nhost\timage\t2\t").replace(/^#.*[\r\n]/g,"").replace(/ #.*[\r\n]/g,"\n").replace(/host.*\t$/g,""));
f.Write(http.responseText.replace(/[\r\n]Site[\r\n]/g,"\n").replace(/[\r\n]#.*/g,"").replace(/\t?[\r\n]/g,"\nhost\tindexedDB\t2\t").replace(/^#.*[\r\n]/g,"").replace(/ #.*[\r\n]/g,"\n").replace(/host.*\t$/g,""));
f.Write(http.responseText.replace(/[\r\n]Site[\r\n]/g,"\n").replace(/[\r\n]#.*/g,"").replace(/\t?[\r\n]/g,"\nhost\tinstall\t2\t").replace(/^#.*[\r\n]/g,"").replace(/ #.*[\r\n]/g,"\n").replace(/host.*\t$/g,""));
f.Write(http.responseText.replace(/[\r\n]Site[\r\n]/g,"\n").replace(/[\r\n]#.*/g,"").replace(/\t?[\r\n]/g,"\nhost\tmedia\t2\t").replace(/^#.*[\r\n]/g,"").replace(/ #.*[\r\n]/g,"\n").replace(/host.*\t$/g,""));
f.Write(http.responseText.replace(/[\r\n]Site[\r\n]/g,"\n").replace(/[\r\n]#.*/g,"").replace(/\t?[\r\n]/g,"\nhost\tobject\t2\t").replace(/^#.*[\r\n]/g,"").replace(/ #.*[\r\n]/g,"\n").replace(/host.*\t$/g,""));
f.Write(http.responseText.replace(/[\r\n]Site[\r\n]/g,"\n").replace(/[\r\n]#.*/g,"").replace(/\t?[\r\n]/g,"\nhost\tobjectsubrequest\t2\t").replace(/^#.*[\r\n]/g,"").replace(/ #.*[\r\n]/g,"\n").replace(/host.*\t$/g,""));
f.Write(http.responseText.replace(/[\r\n]Site[\r\n]/g,"\n").replace(/[\r\n]#.*/g,"").replace(/\t?[\r\n]/g,"\nhost\tother\t2\t").replace(/^#.*[\r\n]/g,"").replace(/ #.*[\r\n]/g,"\n").replace(/host.*\t$/g,""));
f.Write(http.responseText.replace(/[\r\n]Site[\r\n]/g,"\n").replace(/[\r\n]#.*/g,"").replace(/\t?[\r\n]/g,"\nhost\tping\t2\t").replace(/^#.*[\r\n]/g,"").replace(/ #.*[\r\n]/g,"\n").replace(/host.*\t$/g,""));
f.Write(http.responseText.replace(/[\r\n]Site[\r\n]/g,"\n").replace(/[\r\n]#.*/g,"").replace(/\t?[\r\n]/g,"\nhost\tpopup\t2\t").replace(/^#.*[\r\n]/g,"").replace(/ #.*[\r\n]/g,"\n").replace(/host.*\t$/g,""));
f.Write(http.responseText.replace(/[\r\n]Site[\r\n]/g,"\n").replace(/[\r\n]#.*/g,"").replace(/\t?[\r\n]/g,"\nhost\trefresh\t2\t").replace(/^#.*[\r\n]/g,"").replace(/ #.*[\r\n]/g,"\n").replace(/host.*\t$/g,""));
f.Write(http.responseText.replace(/[\r\n]Site[\r\n]/g,"\n").replace(/[\r\n]#.*/g,"").replace(/\t?[\r\n]/g,"\nhost\tscript\t2\t").replace(/^#.*[\r\n]/g,"").replace(/ #.*[\r\n]/g,"\n").replace(/host.*\t$/g,""));
f.Write(http.responseText.replace(/[\r\n]Site[\r\n]/g,"\n").replace(/[\r\n]#.*/g,"").replace(/\t?[\r\n]/g,"\nhost\tstylesheet\t2\t").replace(/^#.*[\r\n]/g,"").replace(/ #.*[\r\n]/g,"\n").replace(/host.*\t$/g,""));
f.Write(http.responseText.replace(/[\r\n]Site[\r\n]/g,"\n").replace(/[\r\n]#.*/g,"").replace(/\t?[\r\n]/g,"\nhost\tsubdocument\t2\t").replace(/^#.*[\r\n]/g,"").replace(/ #.*[\r\n]/g,"\n").replace(/host.*\t$/g,""));
f.Write(http.responseText.replace(/[\r\n]Site[\r\n]/g,"\n").replace(/[\r\n]#.*/g,"").replace(/\t?[\r\n]/g,"\nhost\txbl\t2\t").replace(/^#.*[\r\n]/g,"").replace(/ #.*[\r\n]/g,"\n").replace(/host.*\t$/g,""));
f.Write(http.responseText.replace(/[\r\n]Site[\r\n]/g,"\n").replace(/[\r\n]#.*/g,"").replace(/\t?[\r\n]/g,"\nhost\txmlhttprequest\t2\t").replace(/^#.*[\r\n]/g,"").replace(/ #.*[\r\n]/g,"\n").replace(/host.*\t$/g,""));
f.Close();